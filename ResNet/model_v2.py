...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channel: int, out_channel: int, stride: int = 1,
                 downsample: Optional[nn.Module] = None, **kwargs):
        super().__init__()
...
def resnext50_32x4d(num_classes=1000, include_top=True):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top, groups=32, width_per_group=4)


def resnext101_32x8d(num_classes=1000, include_top=True):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, include_top=include_top, groups=32, width_per_group=8)
