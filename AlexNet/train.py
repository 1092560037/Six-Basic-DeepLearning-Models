...
def main():
    ...
    # 为了方便在 predict 时读取信息，将索引：标签 存入到一个 json 文件中
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset,
                                               batch_size=batch_size, shuffle=True, # 每批训练的样本数、是否打乱训练集
                                               num_workers=nw) # num_workers在windows下设置为0
